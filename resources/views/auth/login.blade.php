...
<head>
  <meta charset="utf-8">
    ...
    <title>Kultur University - Log in </title>
					...
					<div class="col-lg-4 col-md-5 col-12">
                        ...
                        <form method="POST" action="{{ route('login') }}">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('register') }}" class=" ml-5 text-white hover-info">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
